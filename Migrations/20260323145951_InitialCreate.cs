        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusTracking = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lốp xe các hãng", "Lốp xe" },
                    { 2, "Dầu nhớt động cơ", "Dầu nhớt" },
                    { 3, "Ắc quy xe điện/xăng", "Ắc quy" },
                    { 4, "Má phanh, đĩa phanh", "Phanh" },
                    { 5, "Đèn pha, đèn hậu", "Đèn xe" }
                });
